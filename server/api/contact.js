...
export default defineEventHandler(async (event) => {
  ...
  template += `
            <h3>ORDER DELIVERY ADDRESS</h3>
                  ...
                  <p style="font-weight: bold;">Cost to Deliver:  ${useCurrencyFormatter(body.order.deliveryCost)} for delivery</p>
            <h3>PAYMENT DETAILS</h3>
                  ...
                  <p style="font-weight: bold;">Amount Paid:  ${useCurrencyFormatter(body.paymentDetails.Amount)} </p>
  ...
  body.order.products.forEach(item => {
    products += `
                          ...
                          <td style="padding:0;Margin:0;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;color:#333333;font-size:14px;line-height:21px" class="es-text-mobile-size-14">${useCurrencyFormatter(item._value.cumulativeCost)}</td>
      `
  })
  products += '</div>'
                  ...
                  <td align="left" style="padding:0;Margin:0;width:270px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      ...
                      <p style="Margin:0;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px" align="right">${useCurrencyFormatter(body.order.deliveryCost)}</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px" align="right">${useCurrencyFormatter(body.paymentDetails.Amount)}</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table><!--[if mso]></td></tr></table><![endif]--></td>
