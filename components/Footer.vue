  ...
  <footer class="w-full text-white bg-gray-900 body-font">
    <div
      ...
      <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
        ...
        <img :src="logo" alt="" class="w-12 h-auto pb-5">
        <p class="mt-2 text-sm ">Insulated Water Bottle</p>
        <div class="mt-4">
          <span class="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
            <a class="text-white cursor-pointer hover:text-[#39519f]">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-6"
                viewBox="0 0 24 24">
                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
              </svg>
            </a>
            <a class="ml-3 text-white cursor-pointer hover:text-[#39519f]">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-6"
                viewBox="0 0 24 24">
                <path
