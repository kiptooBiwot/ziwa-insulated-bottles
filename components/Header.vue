...
<template>
  <header class="
    ...
    <div class="flex items-center">
      <button @click="generalStore.toggleSidebar()" class="text-gray-500 focus:outline-none lg:hidden">
    ...
    <div class="flex items-center">
      ...
      <div v-if="userStore.user" class="px-2">
        <h4 class="text-sm text-[#395A9F]"> Hello, {{ userStore.user.name.split(' ')[0] }}</h4>
      </div>
      <div class="relative">
        ...
        <transition enter-active-class="transition duration-150 ease-out transform" enter-from-class="scale-95 opacity-0"
          ...
          <div v-show="dropdownOpen" class="
            ...
            <a href="#" class="
              ...
              Settings</a>
            <div @click.prevent="handleLogout" class="
                flex
                px-4
                py-2
                rounded-md
