  ...
  <div>
    ...
    <div class="max-w-3xl mx-auto bg-white shadow-xl rounded-lg p-10">
      ...
      <div class="space-y-2">
        ...
        <div class="grid space-y-1">
          <label for="" class="text-xs">Product Category</label>
          <select
          ...
          >
            ...
            <option
              v-for="(category, index) in generalStore.categories"
              :key="index"
        ...
        <div class="grid space-y-1">
          ...
          <textarea
            ...
            class="border px-4 py-2 text-sm rounded-md"
          ></textarea>
        </div>
        ...
        <div class="pb-10">
              ...
              <div class="grid gap-5 md:flex">
                ...
                <div class="grid space-y-1 w-full">
                  ...
                  <input
                    ...
                    placeholer="E.g. \'carbon:temperature-hot\' "
                    class="border px-4 py-2 rounded-md"
                  />
                </div>
              </div>
          ...
          <div class="flex justify-end">
            <button
              class="text-white bg-rose-500 flex px-6 py-1 rounded-md justify-end font-semibold text-sm"
        ...
        <div
          v-for="(imageDetails, index) in product.images"
          :key="index"
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div class="w-full space-y-3">
              ...
              <div class="grid space-y-1">
                ...
                <input
                  v-model="imageDetails.color"
                  class="border px-4 py-2 rounded-md"
                />
              </div>
              <div class="grid space-y-1">
                <label for="" class="text-xs"
                  >Product Color Code E.g. (#1D4D4B)</label
                >
                <input
                  v-model="imageDetails.colorCode"
                  class="border px-4 py-2 rounded-md"
                />
              </div>
            </div>
        ...
        <div class="flex justify-end">
          <button
            class="text-white bg-rose-500 flex px-6 py-1 rounded-md justify-end font-semibold text-sm"
            @click.prevent="addNewProductImage"
          >
        ...
        <div class="flex justify-between">
          <button
            class="uppercase bg-orange-600 text-white px-6 py-3 rounded-sm text-sm font-semibold"
          >
            Cancel
          </button>
          ...
          >
            ...
            >
              <div
                class="h-5 w-5 border-t-transparent border-solid animate-spin rounded-full border-white border-2"
              ></div>
