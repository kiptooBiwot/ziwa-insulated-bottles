...
<template>
  <div class="min-h-screen">
    ...
    <div class="flex flex-row flex-wrap">
        ...
        <div class="h-full rounded-xl bg-white shadow-2xl">
          <div x-data="{ tooltips: false }" class="relative px-6 pt-6 text-sm font-semibold">
            ...
            <div x-on:mouseover="tooltips = true" x-on:mouseleave="tooltips = false"
              ...
              +12%
              <div class="absolute bottom-full top-auto mb-3" x-show.transition.origin.top="tooltips"
                style="display: none;">
                <div
      ...
      <div class="mb-10 w-full max-w-full flex-shrink px-8 sm:w-1/2 lg:w-1/4">
        <div class="h-full rounded-xl bg-white shadow-2xl">
          <div x-data="{ tooltips: false }" class="relative px-6 pt-6 text-sm font-semibold">Users Online <span
              class="mt-1 h-2 w-2 animate-pulse rounded-full bg-green-500 ltr:float-right rtl:float-left"></span></div>
          <div class="flex flex-row justify-between px-6 py-4">
