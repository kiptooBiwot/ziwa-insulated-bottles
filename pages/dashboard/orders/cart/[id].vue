...
const { singleCartItem } = storeToRefs(orderStore)

onMounted(async () => {
  await orderStore.getSingleCartItem(route.params.id)
})

// UnWRap the product Details
const unwrappedProducts = computed(() => {
  return singleCartItem.value.products.map(
...
<template>
  <div>
    <div v-if="orderStore.singleCartItem" class="">
        ...
        <div class="container px-0 md:px-5 py-0 mx-auto">
          ...
          >
            ...
            <div class="flex-grow sm:text-left mt-6 sm:mt-0">
              ...
              >
                Customer Order (Customer's Orders in Cart Before Payment)
              </h1>
              ...
              <div class="font-bold text-gray-800 space-y-3 mt-5">
                <div class="w-full flex space-x-3">
                  <div class="w-1/2">
                    ...
                    <p>
                      {{ orderStore?.singleCartItem?.orderedBy?.firstName }}
                    </p>
                  </div>
                  <div class="w-1/2">
                    <h2 class="text-gray-400 font-semibold text-xs">
                    ...
                    <p>{{ orderStore?.singleCartItem?.orderedBy?.lastName }}</p>
                  </div>
                </div>
                <div class="w-full flex space-x-3">
                  <div class="w-1/2">
                    ...
                    <p>
                      {{ orderStore?.singleCartItem?.orderedBy?.phoneNumber }}
                    </p>
                  </div>
                  <div class="w-1/2">
                    <h2 class="text-gray-400 font-semibold text-xs">Email</h2>
                    <p>{{ orderStore?.singleCartItem?.orderedBy?.email }}</p>
                  </div>
                </div>
                <div class="w-full flex space-x-3">
                  <div class="w-1/2">
                    <h2 class="text-gray-400 font-semibold text-xs">Address</h2>
                    <p>{{ orderStore?.singleCartItem?.orderedBy?.address }}</p>
                  </div>
                  <div
                    v-if="
                      orderStore?.singleCartItem?.orderedBy?.optionalMessage
                    "
                    class="w-1/2"
                  >
                    <h2 class="text-gray-400 font-semibold text-xs">
                ...
                <div class="w-full flex space-x-3">
                  <div class="w-1/2">
                    ...
                    <p>{{ orderStore?.singleCartItem?.deliveryRoute }}</p>
                  </div>
                  <div class="w-1/2">
                    <h2 class="text-gray-400 font-semibold text-xs">
                      Delivery Area
                    </h2>
                    <p>{{ orderStore?.singleCartItem?.deliveryLocation }}</p>
                  </div>
                </div>
                <div class="w-full flex space-x-3">
                  <div class="w-1/2">
                    ...
                    <p>
                      ...
                      {{ orderStore?.singleCartItem?.deliveryCost }}
                    </p>
                  </div>
                  <div
                    v-if="orderStore?.singleCartItem?.isPaidFor"
                    class="w-1/2"
                  >
                    <h2 class="text-gray-400 font-semibold text-xs">
                      Payment Status
                ...
                <div v-if="orderStore?.singleCartItem?.payment">
                  <div class="w-full flex space-x-3">
                    <div class="w-1/2">
                      <h2 class="text-gray-400 font-semibold text-xs">
                      ...
                      <p>
                        {{
                          orderStore?.singleCartItem?.payment
                            ?.MpesaReceiptNumber
                        }}
                      </p>
                    </div>
                    <div class="w-1/2">
                      ...
                      <p>
                        <span class="text-sm">KSH.</span>
                        {{ orderStore?.singleCartItem?.payment?.Amount }}
                      </p>
                    </div>
                  </div>
                  <div class="w-full flex space-x-3">
                    <div class="w-1/2">
                      ...
                      <p>
                        {{ orderStore?.singleCartItem?.payment?.PhoneNumber }}
                      </p>
                    </div>
                    <div class="w-1/2">
                      <h2 class="text-gray-400 font-semibold text-xs">
                  ...
                  <div class="w-full flex space-x-3">
                    <div class="w-1/2">
                      ...
                      <p>
                        {{ orderStore?.singleCartItem?.payment?.ResultDesc }}
                      </p>
                    </div>
                    <!-- <div class="w-1/2">
                    <h2 class="text-gray-400 font-semibold text-xs">
